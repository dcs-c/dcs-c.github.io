...
# 2. 윈도우 포맷
   ...
   2-1. 보통 이때즈음 오면 드슥만 문제가 아니고 다른곳도 연달아 문제가 터져 윈도우를 포맷하는 과정임이 분명하다.

   그런 당신에게 *어쩌다 이지경까지?* 호칭을 건네며, 윈도우 포맷 방법 설명을 시작할까 한다.

   2-2. 포맷 전에 꼭 해야 할 준비 (중요 ★)
...
제품 키 번호가 보인하면 혹시 모르니 쟁여놓자.

# 2-5. USB 준비 및 윈도우 파일 설치
