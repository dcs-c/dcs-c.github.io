...
제이소우와 제이담은 같은 유도 방식을 사용하기에 사용법 또한 완전히 동일하다 때문에 빠르게 설명하겠다 이해가 되지 않는 부분은 JDAM 항목에서 자세하게 서술되어있으니 참고.
...
이 처럼 제이소우는 제이담과 거의 사용방법이 동일 하나 사거리가 제이담보다 훨씬 길기에 적의 방공망 밖에서 사격하는 경우에는 제이소우를 자주 사용한다
