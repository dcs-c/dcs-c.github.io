...
앞서 설명한 무유도(Unguide) 폭탄은 말그대로 기체 자체의 위치에너지와 운동에너지만을 이용해 컴퓨터가 이를 계산하여 적이 어디에 타격될것인지를 나타내주고 파일럿은 거기에 맞춰 적을 맞추는 방법을 썼었으나 이는 정확도가 상황에 따라서 천차 만별이고 정확한 타격을 위해선 일정한 자세로 진입을 해야한다라는 단점이 있었으나 본 문서에서 설명할 AGM-62 Walleye II는 락온을 건 대상에게 자동으로 찾아가 낙하하는 유도 폭탄이다
